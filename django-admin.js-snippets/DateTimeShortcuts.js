// peppelinux's mod
// it displays hours from 9:00 to 18:00
...
var DateTimeShortcuts = {
    ...
    addClock: function(inp) {
        ...
        quickElement("a", quickElement("li", time_list, ""), gettext("10:00"), "href", "javascript:DateTimeShortcuts.handleClockQuicklink(" + num + ", new Date(1970,1,1,10,0,0,0).strftime('" + time_format + "'));");
        quickElement("a", quickElement("li", time_list, ""), gettext("11:00"), "href", "javascript:DateTimeShortcuts.handleClockQuicklink(" + num + ", new Date(1970,1,1,11,0,0,0).strftime('" + time_format + "'));");
        ...
        quickElement("a", quickElement("li", time_list, ""), gettext("14:00"), "href", "javascript:DateTimeShortcuts.handleClockQuicklink(" + num + ", new Date(1970,1,1,14,0,0,0).strftime('" + time_format + "'));");
        quickElement("a", quickElement("li", time_list, ""), gettext("15:00"), "href", "javascript:DateTimeShortcuts.handleClockQuicklink(" + num + ", new Date(1970,1,1,15,0,0,0).strftime('" + time_format + "'));");        
        ...
        quickElement("a", quickElement("li", time_list, ""), gettext("17:00"), "href", "javascript:DateTimeShortcuts.handleClockQuicklink(" + num + ", new Date(1970,1,1,17,0,0,0).strftime('" + time_format + "'));");
        quickElement("a", quickElement("li", time_list, ""), gettext("18:00"), "href", "javascript:DateTimeShortcuts.handleClockQuicklink(" + num + ", new Date(1970,1,1,18,0,0,0).strftime('" + time_format + "'));");
